...
<html>
	<head>
		...
		<title>Oyster Mushroom Monitoring System</title>
...
<div class="w3-container">
	<div class="w3-container w3-round-large w3-card-4 w3-green">	
...
<br>
			...
			<?php
			$query = "SELECT id, temperature, humidity, pump, fan, light, DATE_FORMAT(date,'%c/%d/%y - %h:%i %p') AS date FROM dht11 ORDER BY `dht11`.`id` DESC Limit 480";
